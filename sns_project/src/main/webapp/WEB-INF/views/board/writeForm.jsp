...
<div class="write_wrap">
  <form method="post" action="${pageContext.request.contextPath }/board/write.do" class="write_wrap" enctype="multipart/form-data">
<fieldset>
<legend>글쓰기</legend>
   <div class="clearFix">
   <input type="text" name="writer" placeholder="작성자" value="${member.id }" readonly class="hiddenItem">
      <div class="col1 sideL">
         ...
         <span id="imagePreview"></span>
					<span><input id="image" type="file" class="profile" name="file" onchange="InputImage();"></span>
      </div>
      <div class="box col2 sideR">
         <textarea name="content" class="txtArea" placeholder="글을 작성하세요..." required></textarea>
      </div>
   </div>
   <div class="bt1"><input type="submit" value="확인" class="ok"></div>
   </fieldset>	
  </form>
